...
export type Event =
  ...
  | EventTodoUpdated
  | EventSessionNextOrchestratorPlanStarted
  | EventSessionNextOrchestratorPlanned
  | EventSessionNextOrchestratorIterationStarted
  | EventSessionNextOrchestratorSubtaskStarted
  | EventSessionNextOrchestratorWorkerStep
  | EventSessionNextOrchestratorObservation
  | EventSessionNextOrchestratorSubtaskFinished
  | EventSessionNextOrchestratorReduced
  | EventSessionNextOrchestratorVerified
  | EventSessionNextOrchestratorFinished
  | EventLspUpdated
  ...
  payload:
    ...
    | {
        ...
        properties: {
          timestamp: number
          sessionID: string
          subtasks: Array<SessionNextOrchestratorSubtask>
        }
      }
    | {
        id: string
...
export type V2Event =
  ...
  | QuestionV2Rejected
  | TodoUpdated
  | SessionNextOrchestratorPlanStarted
  | SessionNextOrchestratorPlanned
  | SessionNextOrchestratorIterationStarted
  | SessionNextOrchestratorSubtaskStarted
  | SessionNextOrchestratorWorkerStep
  | SessionNextOrchestratorObservation
  | SessionNextOrchestratorSubtaskFinished
  | SessionNextOrchestratorReduced
  | SessionNextOrchestratorVerified
  | SessionNextOrchestratorFinished
  | LspUpdated
  | PermissionAsked
  | PermissionReplied
  | TuiPromptAppend
...
export type SessionNextOrchestratorSubtask = {
  id: string
  description: string
...
export type SessionNextOrchestratorPlanStarted = {
  id: string
  metadata?: {
    [key: string]: unknown
  }
...
export type SessionNextOrchestratorPlanned = {
  id: string
  metadata?: {
    [key: string]: unknown
  }
...
export type SessionNextOrchestratorIterationStarted = {
  id: string
  metadata?: {
    [key: string]: unknown
  }
...
export type SessionNextOrchestratorSubtaskStarted = {
  id: string
  metadata?: {
    [key: string]: unknown
  }
...
export type SessionNextOrchestratorWorkerStep = {
  id: string
  metadata?: {
    [key: string]: unknown
  }
...
export type SessionNextOrchestratorObservation = {
  id: string
  metadata?: {
    [key: string]: unknown
  }
...
export type SessionNextOrchestratorSubtaskFinished = {
  id: string
  metadata?: {
    [key: string]: unknown
  }
...
export type SessionNextOrchestratorReduced = {
  id: string
  metadata?: {
    [key: string]: unknown
  }
...
export type SessionNextOrchestratorVerified = {
  id: string
  metadata?: {
    [key: string]: unknown
  }
...
export type SessionNextOrchestratorFinished = {
  id: string
  metadata?: {
    [key: string]: unknown
  }
...
export type EventSessionNextOrchestratorPlanStarted = {
  id: string
  type: "session.next.orchestrator.plan.started"
  properties: {
    timestamp: number
...
export type EventSessionNextOrchestratorPlanned = {
  id: string
  type: "session.next.orchestrator.planned"
  properties: {
    timestamp: number
...
export type EventSessionNextOrchestratorIterationStarted = {
  id: string
  type: "session.next.orchestrator.iteration.started"
  properties: {
    timestamp: number
...
export type EventSessionNextOrchestratorSubtaskStarted = {
  id: string
  type: "session.next.orchestrator.subtask.started"
  properties: {
    timestamp: number
...
export type EventSessionNextOrchestratorWorkerStep = {
  id: string
  type: "session.next.orchestrator.worker.step"
  properties: {
    timestamp: number
...
export type EventSessionNextOrchestratorObservation = {
  id: string
  type: "session.next.orchestrator.observation"
  properties: {
    timestamp: number
...
export type EventSessionNextOrchestratorSubtaskFinished = {
  id: string
  type: "session.next.orchestrator.subtask.finished"
  properties: {
    timestamp: number
...
export type EventSessionNextOrchestratorReduced = {
  id: string
  type: "session.next.orchestrator.reduced"
  properties: {
    timestamp: number
...
export type EventSessionNextOrchestratorVerified = {
  id: string
  type: "session.next.orchestrator.verified"
  properties: {
    timestamp: number
...
export type EventSessionNextOrchestratorFinished = {
  id: string
  type: "session.next.orchestrator.finished"
  properties: {
    timestamp: number
